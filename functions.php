...
//		wp_enqueue_style( 'style', get_template_directory_uri() . '/style.css', null, null );
        ...
        wp_enqueue_style('font-google', 'https://fonts.googleapis.com/css2?family=Crete+Round&family=Lato:ital,wght@0,400;0,700;1,400;1,700&family=Oswald&display=swap', null, null);
        wp_enqueue_style('font-awesome', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.9.0/css/all.min.css', null, null);
...
if ( function_exists( 'acf_add_options_page' ) ) {
    ...
    acf_add_options_page( array(
        'page_title' => 'Review Archive Settings',
        'menu_title' => 'Review Archive',
        'parent_slug'  => 'theme-general-settings',
        'menu-slug'  => 'archive-review_post',
        'capability' => 'edit_posts',
        'post_id' => 'review_post',
        'redirect'   => false,
    ) );
...
function func_remove_admin_menus_plugins() {
    if (function_exists('remove_menu_page')) {
        remove_menu_page('edit-comments.php'); // to remove comments from admin
        remove_menu_page('edit.php'); // to remove posts from admin
    }
}
add_action('admin_menu', 'func_remove_admin_menus_plugins');
